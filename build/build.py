...
if __name__ == '__main__':
  ...
  opt.add_option("--amd", dest="amd", help="output should be AMD module; wrap merged files in define function; can be either 'pre' (before compilation) or 'post' (after compilation).  Using pre means the compiler may use more aggressive optimisations. Default false, not AMD.", default=False)
