...
OpenLayers.Bounds.oppositeQuadrant = function(quadrant) {
    ...
    if (quadrant.charAt(0) === 't') {
        opp += 'b';
    } else if (quadrant.charAt(0) === 'b') {
        opp += 't';
    } else {
        throw new TypeError('Bounds.oppositeQuadrant must receive t or b as first character');
    }
        
    if (quadrant.charAt(1) === 'l') {
        opp += 'r';
    } else if (quadrant.charAt(1) === 'r') {
        opp += 'l';
    } else {
        throw new TypeError('Bounds.oppositeQuadrant must receive l or r as second character');
    }
