...
OpenLayers.Control.ArcIntersection = OpenLayers.Class(OpenLayers.Control, {
     ...
     *     an object with a *feature* property referencing the layer.
     */
    ...
    updateIntersection: function() {
        ...
        if ( (d_sq > 0) && (d_sq <= (r0 + r1) * (r0 + r1)) && (d_sq >= (r0 - r1) * (r0 - r1)) ) {
            ...
            for (var i=0; i<intersections.length; i++) {
                var intersectionFeature = new OpenLayers.Feature.Vector(intersections[i]);
    ...
    updateCircles: function() {
        ...
        for (var i=0; i<this.circles.length; i++) {
            ...
            if (circle.center != null && circle.radius != null) {
                ...
                var centerFeature = new OpenLayers.Feature.Vector(circle.center);
                // mark as temporary
