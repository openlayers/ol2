...
OpenLayers.Control.CacheRead = OpenLayers.Class(OpenLayers.Control, {
    ...
    fetch: function(evt) {
        if (this.active && this.cacheControl.isAvailable() &&
            ...
            if (this.cacheControl.isAsync()) {
                tile.url = tile.blankImageUrl;
            }
            var self = this;
            var dataURI = this.cacheControl.getItem("olCache_" + url, function(dataURI) {
                if (dataURI) {
                    if (self.cacheControl.isAsync()) {
