...
OpenLayers.Control.LayerSwitcher = 
  ...
  // DOM Elements
    ...
    redraw: function() {
        ...
        for(var i=0, len=layers.length; i<len; i++) {
            ...
            if (layer.displayInLayerSwitcher) {
                ...
                groupArray.push({
                    'layer': layer,
                 // 'inputElem': link.appendChild(inputElem),
                    'inputElem': inputElem,
                    'labelSpan': labelSpan
                });
    ...
    loadContents: function() {
        ...
        img.alt = OpenLayers.i18n("Maximize");
        ...
        img.alt = OpenLayers.i18n("Minimize");
