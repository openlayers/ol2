...
OpenLayers.Control.ModifyFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    collectDragHandle: function() {
        ...
        var origin = new OpenLayers.Feature.Vector(
            originGeometry, null, this.virtualStyle
        );
    ...
    collectRadiusHandle: function() {
        ...
        var radius = new OpenLayers.Feature.Vector(
            radiusGeometry, null, this.virtualStyle
        );
