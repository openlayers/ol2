...
OpenLayers.Control.ModifyFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    initialize: function(layer, options) {
        ...
        if (this.bySegment) {
            if (!window.rbush) {
                OpenLayers.Console.error("The rbush library is required");
            }
            if (!OpenLayers.Control.ModifyFeatureBySegment) {
                OpenLayers.Console.error("OpenLayers.Control.ModifyFeatureBySegment is missing from the build");
            } else {
                OpenLayers.Util.extend(this, OpenLayers.Control.ModifyFeatureBySegment);
            }
        }    
    },
