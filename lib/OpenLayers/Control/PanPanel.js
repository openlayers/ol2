...
OpenLayers.Control.PanPanel = OpenLayers.Class(OpenLayers.Control.Panel, {
    ...
    initialize: function(options) {
        ...
        this.addControls([
            new OpenLayers.Control.Pan(OpenLayers.Control.Pan.NORTH, opts),
            new OpenLayers.Control.Pan(OpenLayers.Control.Pan.SOUTH, opts),
            new OpenLayers.Control.Pan(OpenLayers.Control.Pan.EAST, opts),
            new OpenLayers.Control.Pan(OpenLayers.Control.Pan.WEST, opts)
        ]);
    },
    ...
    destroy: function() {
        ...
        var idx = (this.controls) ? this.controls.length : 0;
        while (idx--) {
            this.controls[idx].destroy();
        }
    },
