...
OpenLayers.Control.SelectFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * APIProperty: regularpolygon
     * {Boolean} Allow feature selection by drawing a regular polygon.
     */
    ...
    activate: function () {
        if (!this.active) {
            ...
            if(this.regularpolygon && this.handlers.regularpolygon) {
    ...
    deactivate: function () {
        if (this.active) {
            ...
            if(this.handlers.regularpolygon) {
     ...
     * Callback from the handlers.regularpolygon and  handlers.polygon set up when <regularpolygon> or
     * <polygon> selection is true.
     *     
     *
     * Parameters:
     * geometry - {<OpenLayers.Geometry> || <OpenLayers.Geometry> }  
     */
