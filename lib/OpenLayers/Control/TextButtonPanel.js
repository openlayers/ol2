...
OpenLayers.Control.TextButtonPanel = OpenLayers.Class(
  OpenLayers.Control.Panel, {
     ...
     * This functino overrides onButtonClick in <OpenLayers.Control.Panel> by
     * updating the clicked button's text after it has been activated, in
     * case the button toggles an application state that is reflected in its
     * text.
     * Parameters:
     * evt - {Event}
     */
