 ...
 *
 * The most common example may be a XYZ layer containing feature
 * attributes that are displayed in a div as you mouseover.
 *
 * Example Code:
 *
 * (start code)
 * var world_utfgrid = new OpenLayers.Layer.XYZ('UTFGrid',
 *     'http://tiles/world_utfgrid/${z}/${x}/${y}.json', {
 *         tileClass: OpenLayers.Tile.UTFGrid,
 *         tileOptions: {
 *             utfgridResolution: 4  // the default is 2
 *         }
 * });
...
OpenLayers.Control.UTFGrid = OpenLayers.Class(OpenLayers.Control, {
    ...
    /** 
     * APIProperty: layers
     * List of layers to consider, `null` is the default indicating
     * all the map layers are queried.
     * Only layers whose tile.getFeatureInfo is a function are
     * considered. (eg. <OpenLayers.Tile.UTFGrid>)
