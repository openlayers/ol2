 ...
 * The ZoomBar control is a visible control composed of a vertical
 * zomm bar.
 *
 * Inherits from:
 *  - <OpenLayers.Control>
...
OpenLayers.Control.ZoomBar = OpenLayers.Class(OpenLayers.Control, {
    ...
    zoomBarDown:function(evt) {
        ...
        this.div.className = "olControlZoomBar olControlNoSelect olControlZoomBarMove";
    ...
    zoomBarUp: function(evt) {
        ...
        if (this.zoomStartY != -1) {
            this.div.className = "olControlZoomBar olControlNoSelect";
            this.map.events.un({
                "touchmove": this.passEventToSlider,
                "mouseup": this.passEventToSlider,
                "mousemove": this.passEventToSlider,
