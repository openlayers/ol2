    ...
    writers: {
        "gml": OpenLayers.Util.applyDefaults({
            ...
            "pos": function(point) {
                ...
                var dimension = (typeof point.z === "number" && !isNaN(point.z)) ? 3 : null;
                if (dimension === 3) {
                    pos += " " + point.z;
                }
                return this.createElementNSPlus("gml:pos", {
                    value: pos, attributes: {dimension: dimension}
                });
            },
            ...
            "posList": function(points) {
                ...
                if (len) {
                    var dimension = (typeof points[0].z === "number" && !isNaN(points[0].z)) ? 3 : null;
                    var point;
                    for (var i=0; i<len; ++i) {
                        point = points[i];
                        if (this.xy) {
