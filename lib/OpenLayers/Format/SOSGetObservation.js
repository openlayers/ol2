    ...
    readers: {
        ...
        "swe": {
            ...
            "Count": function(node, dataArray) {
                ...
                dataArray.count = parseInt(count.value);
            },
            ...
            "values": function(node, dataArray) {
                ...
                var expectedRecordLength = dataArray.dataRecord.length;
                var blocks = encodedValues.split(dataArray.encoding.blockSeparator);
                blocks.forEach(function(block) {
                    var tokens = block.split(dataArray.encoding.tokenSeparator);
                    if (tokens.length == expectedRecordLength) values.push(tokens);
                });
            }
        }
    },
