    ...
    readers: {
        "wcs": OpenLayers.Util.applyDefaults({
            ...
            "spatialDomain": function(node, domain) {
                ...
                domain.spatialDomain.envelopes = {};
        ...
        // Use a custom Envelope reader that reads the srsName attribute
        "gml": OpenLayers.Util.applyDefaults({
            "Envelope": function(node, spatialDomain) {
                ...
                var envelope = new OpenLayers.Bounds(min.x, min.y, max.x, max.y);
                envelope.srsName = srsName;
                // Probably not needed, but seems good practice to avoid confusion
                envelope.CLASS_NAME += "_withSRS";     

                spatialDomain.envelopes[srsName] = envelope;
            }
