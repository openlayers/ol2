...
OpenLayers.Format.WCSDescribeCoverage.v1_0_0 = OpenLayers.Class(
    ...
    readers: {
        "wcs": OpenLayers.Util.applyDefaults({
            ...
            // that name because it is... better.
            ...
            "lonLatEnvelope": function(node, description) {
                ...
                //     description.lonLatEnvelope = {};
                //     description.lonLatEnvelope.srsName = node.getAttribute("srsName");
                //     description.lonLatEnvelope.min = min.points[0];
                //     description.lonLatEnvelope.max = max.points[0];
                // }
            },
            ...
            "spatialDomain": function(node, domain) {
                // domain.boundingBoxes = [];
                // var xxx = {};
                // this.readChildNodes(node, xxx);
                // domain.boundingBoxes.push(xxx);
                domain.spatialDomain = this.readChildNodes(node, domain.spatialDomain);
            },
