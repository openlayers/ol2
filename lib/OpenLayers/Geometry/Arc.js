/* Copyright (c) 2008 Dmitry Egorkin and 2006-2008 MetaCarta, Inc. Create for OpenLayers project, published under the Clear BSD
 ...
 */
OpenLayers.Geometry.Arc = OpenLayers.Class(OpenLayers.Geometry.Curve, {
     ...
     * Only allows removal of a point if there are five or more (base + control) points in 
    ...
    CLASS_NAME: "OpenLayers.Geometry.Arc"
});
