...
OpenLayers.Handler.Feature = OpenLayers.Class(OpenLayers.Handler, {
    ...
    EVENTMAP: {
        ...
        'touchstart': {'in': null, 'out': 'clickout'},
    ...
    /**
     * Property: stopEnd
     * {Boolean} If stopEnd is set to true, handled touchends do not
     *      propagate to other touchend listeners. Otherwise, handled touchends
     *      do propagate. Unhandled touchends always propagate, whatever the
     *      value of stopEnd. Defaults to false.
     */
    stopEnd: false,
    ...
    /**
     * Method: touchend
     * Handle touch end.  Stop propagation if a feature is targeted by this
     *     event.
     *
     * Parameters:
     * evt - {Event}
    ...
    touchend: function(evt) {
        this.up = this.last;
        return this.handle(evt) ? !this.stopEnd : true;
    },
