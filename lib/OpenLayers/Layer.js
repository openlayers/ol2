    ...
    setVisibility: function(visibility) {
        if (visibility != this.visibility) {
            ...
            if (this.map != null) {
                ...
                if (visibility === false) {
                    // moveTo is not called while the layer is invisible, so
                    // we clear the resolution to make sure that redraw()
                    // repositions the layer properly when the layer is made
                    // visible again.
                    this.resolution = null;
                }
            }
