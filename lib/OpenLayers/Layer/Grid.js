    ...
    */
    ...
    applyBackBuffer: function(resolution) {
        ...
        for (var i=tiles.length-1; i>=0; --i) {
            tile = tiles[i];
            tile.style.top = ((ratio * tile._i * this.tileSize.h) | 0) + 'px';
            tile.style.left = ((ratio * tile._j * this.tileSize.w) | 0) + 'px';
            ...
            for(var i=0, lenI=this.grid.length; i<lenI; i++) {
                for(var j=0, lenJ=this.grid[i].length; j<lenJ; j++) {
                    ...
                    if (markup) {
                        markup._i = i;
                        markup._j = j;
                        var imageSize = this.getImageSize(tile.bounds);
                        markup._w = imageSize.w;
                        markup._h = imageSize.h;
