...
OpenLayers.Layer.Vector = OpenLayers.Class(OpenLayers.Layer, {
     ...
     * Returns an array of features that have the given property set to the
     ...
     * passed property set to the given value.
     */
    getFeaturesBy: function(property, value) {
        ...
        for (i = 0; i < len; i++) {
            feature = this.features[i];
            if (OpenLayers.Util.getProperty(property, feature) === value) {
