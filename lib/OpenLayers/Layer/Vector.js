...
OpenLayers.Layer.Vector = OpenLayers.Class(OpenLayers.Layer, {
     ...
     *      will receive an object with a *feature* property referencing the
     *      selected feature. If triggered by <OpenLayers.Control.SelectFeature>,
     *      the object will also have an *xy* property with an <OpenLayers.Pixel>
     *      instance containing the pixel that was clicked to select the feature
     *      or the center of the selection box.
