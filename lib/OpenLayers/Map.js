...
OpenLayers.Map = OpenLayers.Class({
  ...
  // Options
    ...
    /**
     * APIProperty: tileManagerOptions
     * {Object} Optional options to configure the tileManager instance with.
     * See the API docs of {<OpenLayers.TileManager>} for more info on which
     * options exist.
     */
    tileManagerOptions: null,
    
    /**
     * APIProperty: tileManager
     * {<OpenLayers.TileManager>} By default the map will use the TileManager
