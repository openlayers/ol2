...
OpenLayers.Map = OpenLayers.Class({
  ...
  // Options
     ...
     *     If <projection> is one of those defined in <OpenLayers.Projection.defaults>
     *     (EPSG:4326 or web mercator), maxExtent will be set to the value defined there;
     *     else, defaults to null.
     *     Set in the map options to specify the default maximum extent in projected coordinates
     *     for layers added to the map.
     *     To restrict user panning and zooming of the map, use <restrictedExtent> instead.
     *     To access the maxExtent of the currently displayed map, use the
     *     <getMaxExtent> accessor method.
     */
    maxExtent: null,
     ...
     *     Set in the map options to specify the default minimum extent in projected coordinates
     *     for layers added to the map.
     */
    minExtent: null,
   ...
   /** 
    ...
    moveTo: function(lonlat, zoom, options) {
        ...
        if (!this.getCachedCenter() && !this.isValidLonLat(lonlat)) {
            lonlat = this.getMaxExtent().getCenterLonLat();
