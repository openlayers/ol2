...
OpenLayers.Map = OpenLayers.Class({
  ...
  //
     ...
     *
     * Parameters:
     * xy - {<OpenLayers.Pixel>} A source pixel on the screen which
     *     will become the center at the provided target resolution.
     * resolution - {Float} The resolution we want to get the center for
     *
     * Returns:
     * {<OpenLayers.LonLat>} The location of the map center after the
     *     transformation described by the source xy and the target resolution.
     */
