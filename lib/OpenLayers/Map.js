   ...
   /** 
    ...
    moveTo: function(lonlat, zoom, options) {
        ...
        if(this.restrictedExtent != null) {
            ...
            if (this.baseLayer.wrapDateLine) {
                extent = extent.wrapDateLine(this.maxExtent);

                /* handle the case where someone requested an extent in the
                 * eastern hemisphere, but the restricted extents are wrapped
                 * around from the western hemisphere */
                if (this.restrictedExtent.left < -180 && extent.left > 0) {
                    extent.left -= 360;
                    extent.right -= 360;
                }
            }
        ...
        if (zoomChanged || centerChanged || dragging) {
            ...
            if (zoomChanged || this.layerContainerOrigin == null) {
                ...
                var centerlon = this.center.lon;
                var maxextlon = maxExtentCenter.lon;
                ...
                var lonDelta = centerlon - maxextlon;
    ...
    centerLayerContainer: function (lonlat) {
        ...
        if (lonlat == null || this.layerContainerOrigin == null);
            return;

        var lonlat = lonlat.clone();
        var origin = this.layerContainerOrigin;
        ...
        var originPx = this.getViewPortPxFromLonLat(origin);
