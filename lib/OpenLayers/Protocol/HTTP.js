...
OpenLayers.Protocol.HTTP = OpenLayers.Class(OpenLayers.Protocol, {
     ...
     * {String} MIME type override, read-only, set through the options
     *     passed to constructor.
     */
     ...
     * overrideMimeType - (String) Optional MIME type to override for the response. 
     *
     * Returns:
        ...
        if(options.callback) {
            ...
            if(request.status >= 200 && request.status < 300) {
                ...
                if(resp.requestType != "delete") {
                	var features = this.parseFeatures(request, options, resp);
                	
                	if (features != null) {
                    	resp.features = features;
                   	} else {
                   		// the format will call the callback for us
     ...
     */
    parseFeatures: function(request, options, resp) {
        ...
        return this.format.read(doc, options, resp);
    },
