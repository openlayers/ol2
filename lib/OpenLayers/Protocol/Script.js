...
OpenLayers.Protocol.Script = OpenLayers.Class(OpenLayers.Protocol, {
     ...
     * response = {<OpenLayers.Protocol.Response>} A response object, whose "priv" property
     *     references the injected script.
     * callback - {Function} Callback to be called with resulting data.
     *
     * Returns:
     * {HTMLScriptElement} The script pending execution.
     */
    createRequest: function(url, params, response, callback) {
        ...
        response.priv = this.pendingRequests[script.id] = script;
