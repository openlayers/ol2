...
OpenLayers.Renderer.Canvas = OpenLayers.Class(OpenLayers.Renderer, {
    ...
    drawText: function(location, style) {
        ...
        var labelAngle = style.labelAngle || 0.0;
        var labelXOffset = parseFloat(style.labelXOffset) || 0.0;
        var labelYOffset = parseFloat(style.labelYOffset) || 0.0;
        ...
        if (this.canvas.fillText) {
            ...
            pt[0] += labelXOffset;
            pt[1] += lineHeight*vfactor*(numRows-1) + labelYOffset;
            this.canvas.translate(pt[0], pt[1]);
            this.canvas.rotate(labelAngle * Math.PI / 180);
            for (var i = 0; i < numRows; i++) {
                if (style.labelOutlineWidth) {
                    this.canvas.save();
                    this.canvas.strokeStyle = style.labelOutlineColor;
                    this.canvas.lineWidth = style.labelOutlineWidth;
                    this.canvas.strokeText(labelRows[i], 0.0, (lineHeight*i) + 1);
                    this.canvas.restore();
                }
                this.canvas.fillText(labelRows[i], 0.0, (lineHeight*i));
            }
            this.canvas.rotate(-labelAngle * Math.PI / 180);
            this.canvas.translate(-pt[0], -pt[1]);
