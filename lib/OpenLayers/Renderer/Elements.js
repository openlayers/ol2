...
OpenLayers.Renderer.Elements = OpenLayers.Class(OpenLayers.Renderer, {
    ...
    drawGeometryNode: function(node, geometry, style) {
        ...
        switch (geometry.CLASS_NAME) {
            ...
            case "OpenLayers.Geometry.Arc":
                drawn = this.drawArc(node, geometry);
                break;
            default:
                break;
        }
    ...
    /**
     * Method: drawArc
     * Virtual function for drawing Arc Geometry. 
     *     Should be implemented by subclasses.
     *     This method is only called by the renderer itself.
     * 
     * Parameters: 
     ...
     * 
     * Returns:
     * {DOMElement} or false if the renderer could not draw the arc
     */ 
    drawArc: function(node, geometry) {},
