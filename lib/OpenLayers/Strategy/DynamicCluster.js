...
//                 "beforefeaturesadded":   this.addFeatures,   /// Return false if clustered
                "beforefeatureremoved":  this.removeFeature,
                "beforefeaturemodified": this.modifyFeature,
                "beforefeatureselected": this.selectFeature,
                "featureunselected":     this.unselectFeature,
                "moveend": this.cluster,    // FIXME
                scope: this
            });
        }
        return activated;
    ...
    /**
     * Method: cacheAllFeatures
     * Cache features before they are added to the layer and calculate all
     *     clusters.
     *
     * Parameters:
     ...
     */
    cacheAllFeatures: function(event) {
//         var propagate = true;
//         if(!this.clustering) {
//             this.clearCache();
...
//         }
    ...
    cluster: function(event) {
        ...
        /// TODO: Do this only when zooming
        this.layer.removeFeatures(this.clusters);
        this.clusters = [];

        /// TODO: Clear feature[i].inCluster only when zooming - when panning,
        ///   we want to calculate clusters only for features in the viewport.
        ...
        for(var i=0; i<this.features.length; ++i) {
            ...
            if(feature.geometry) {
//                 this.removeFromCluster(feature.inCluster, feature);
